...
\begin{Name}{3}{icetWallTime}{Kenneth Moreland}{\IceT Reference}{\CFunc{icetWallTime} -- timer function}
  ...
  time of various subprocesses. \CFunc{icetWallTime} is used internally for
  determining the values for the state variables
  \CEnum{ICET\_BUFFER\_READ\_TIME}, \CEnum{ICET\_BUFFER\_WRITE\_TIME},
  \CEnum{ICET\_COLLECT\_TIME}, \CEnum{ICET\_COMPARE\_TIME},
  \CEnum{ICET\_COMPOSITE\_TIME}, \CEnum{ICET\_COMPRESS\_TIME},
  \CEnum{ICET\_INTERLACE\_TIME}, \CEnum{ICET\_RENDER\_TIME}, and
