...
\CEnum{ICET\_TILE\_MAX\_HEIGHT}.  A well desgined compositing algorithm
...
\IceT also provides several functions for retreiving data from
...
directly accessing the data in an \CType{IceTSparseImage}.  Data is
indirectly manipulated via compression and compositing functions, which are
