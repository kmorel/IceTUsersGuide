...
page~\pageref{sec:Basic_Usage:Diagnostics}, alert the user of anomalous
...
In the documentation for these functions, the type for \CArg{arg$i$} is
left out.  The type of these arguments is determined by the
