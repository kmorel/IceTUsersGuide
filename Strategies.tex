...
with raw data whereas \CFunc{icetGetCompressedTileImages} will compress the
...
it is up to the strategy to count how many bytes are being transmitted in your

Don't forget transferring images.
